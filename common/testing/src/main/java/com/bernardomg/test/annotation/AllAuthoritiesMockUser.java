...
package com.bernardomg.test.annotation;
...
@WithMockUser(authorities = { "BALANCE:READ", "FEE_YEAR:READ", "MEMBER_STATS:READ", "FEE:CREATE", "FEE:READ",
        ...
        "RESOURCE:UPDATE", "RESOURCE:DELETE", "LIBRARY_BOOK_TYPE:READ", "LIBRARY_BOOK_TYPE:CREATE",
        "LIBRARY_BOOK_TYPE:UPDATE", "LIBRARY_BOOK_TYPE:DELETE" })
