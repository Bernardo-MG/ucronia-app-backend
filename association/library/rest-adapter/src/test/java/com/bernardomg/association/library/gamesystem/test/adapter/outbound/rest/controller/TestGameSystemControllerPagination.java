...
class TestGameSystemControllerPagination {
    ...
    void testGetAllGameSystems_InvalidSizeZero() throws Exception {
        // GIVEN
    ...
    void testGetAllGameSystems_PageZero() throws Exception {
        // GIVEN
        given(service.getAll(eq(new Pagination(2, 5)), any()))
            .willReturn(new Page<>(List.of(), 10, 5, 0, 0, 0, false, false, Sorting.unsorted()));

        // WHEN + THEN
        mockMvc.perform(get("/library/gameSystem").param("page", "2")
            .param("size", "5")
            .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk());
    }
    ...
    void testGetAllGameSystems_Pagination() throws Exception {
        // GIVEN
        given(service.getAll(eq(new Pagination(1, 10)), any()))
            .willReturn(new Page<>(List.of(), 10, 5, 0, 0, 0, false, false, Sorting.unsorted()));
