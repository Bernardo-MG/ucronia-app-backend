...
public class ReadMemberEntity implements Serializable {
    ...
    private Collection<ReadMemberContactChannelEntity> contactChannels;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof final ReadMemberEntity other)) {
            return false;
        }
    ...
    public Collection<ReadMemberContactChannelEntity> getContactChannels() {
    ...
    public void setContactChannels(final Collection<ReadMemberContactChannelEntity> contactChannels) {
