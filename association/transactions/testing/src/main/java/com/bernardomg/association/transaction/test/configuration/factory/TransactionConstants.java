...
public final class TransactionConstants {
    ...
    public static final String    DESCRIPTION_FEE_DECEMBER_JANUARY = "Cuota de Name 1 Last name 1 para Diciembre 2020, Enero 2021";

    public static final String    DESCRIPTION_FEE_FEBRUARY         = "Cuota de Name 1 Last name 1 para Febrero 2020";

    public static final String    DESCRIPTION_FEE_FEBRUARY_MARCH   = "Cuota de Name 1 Last name 1 para Febrero 2020, Marzo 2020";
