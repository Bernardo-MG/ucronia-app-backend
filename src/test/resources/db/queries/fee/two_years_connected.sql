...
INSERT INTO association.fees (id, member_id, date, paid, transaction_id) VALUES
   (1, 1, '2019-10-01', true, 1),
   (2, 1, '2019-11-01', true, 2),
   (3, 1, '2019-12-01', true, 3),
   (4, 1, '2020-01-01', true, 4),
   (5, 1, '2020-02-01', true, 5),
   (6, 1, '2020-03-01', true, 6),
   (7, 1, '2020-04-01', true, 7),
   (8, 1, '2020-05-01', true, 8),
   (9, 1, '2020-06-01', true, 9),
   (10, 1, '2020-07-01', true, 10);
