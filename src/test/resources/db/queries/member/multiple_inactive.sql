INSERT INTO directory.contacts (id, number, first_name, last_name, identifier, birth_date, comments, types) VALUES
   (1, 10, 'Contact 1', 'Last name 1', '10', '1990-01-01 0:0:0', 'Comments', '["member"]'),
   (2, 20, 'Contact 2', 'Last name 2', '20', '1990-01-01 0:0:0', 'Comments', '["member"]'),
   (3, 30, 'Contact 3', 'Last name 3', '30', '1990-01-01 0:0:0', 'Comments', '["member"]'),
   (4, 40, 'Contact 4', 'Last name 4', '40', '1990-01-01 0:0:0', 'Comments', '["member"]'),
   (5, 50, 'Contact 5', 'Last name 5', '50', '1990-01-01 0:0:0', 'Comments', '["member"]');
