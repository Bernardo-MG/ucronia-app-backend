...
import com.bernardomg.security.password.test.constant.ChangePasswordConstant;
...
public class ITPasswordRecoveryServiceChange {
    ...
    public final void testChangePassword_Existing_Changed() {
        ...
        service.changePassword(ChangePasswordConstant.TOKEN, "1234", "abc");
    ...
    public final void testChangePassword_Existing_Status() {
        ...
        status = service.changePassword(ChangePasswordConstant.TOKEN, "1234", "abc");
    ...
    public final void testChangePassword_IncorrectPassword_Status() {
        ...
        status = service.changePassword(ChangePasswordConstant.TOKEN, "def", "abc");
