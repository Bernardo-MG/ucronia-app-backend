...
public final class Fees {
    ...
    public static final Fee alternative() {
        ...
        contact = new Fee.Member(ContactConstants.ALTERNATIVE_NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.ALTERNATIVE_INDEX);
        return new Fee(FeeConstants.DATE, true, contact, Optional.of(transaction));
    }

    public static final Fee alternativeContact() {
        final Fee.Member      contact;
        final Fee.Transaction transaction;
        final ContactName     name;
    ...
    public static final Fee noLastName() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, "");
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return new Fee(FeeConstants.DATE, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee notPaid() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        return Fee.unpaid(FeeConstants.DATE, contact);
    }
    ...
    public static final Fee notPaidCurrentMonth() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        return Fee.unpaid(FeeConstants.CURRENT_MONTH, contact);
    }
    ...
    public static final Fee notPaidForMonth(final long index, final long number, final Month month) {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(number, name);
        return Fee.unpaid(YearMonth.of(FeeConstants.YEAR_VALUE, month), contact);
    }
    ...
    public static final Fee notPaidForMonth(final long index, final Month month) {
        ...
        name = new ContactName("Contact " + index, "Last name " + index);
        // TODO: check this number, it should use a constant
        contact = new Fee.Member(index * 10, name);
        return Fee.unpaid(YearMonth.of(FeeConstants.YEAR_VALUE, month), contact);
    }
    ...
    public static final Fee notPaidNextYear() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        return Fee.unpaid(FeeConstants.NEXT_YEAR_MONTH, contact);
    }
    ...
    public static final Fee notPaidPreviousMonth() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        return Fee.unpaid(FeeConstants.PREVIOUS_MONTH, contact);
    }
    ...
    public static final Fee notPaidTwoMonthsBack() {
        ...
        name = new ContactName(ContactConstants.FIRST_NAME, ContactConstants.LAST_NAME);
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        return Fee.unpaid(FeeConstants.TWO_MONTHS_BACK, contact);
    }
    ...
    public static final Fee paidCurrentMonth() {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return new Fee(FeeConstants.CURRENT_MONTH, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidFirstNextYear(final long index) {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return new Fee(FeeConstants.FIRST_NEXT_YEAR_DATE, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidForMonth(final int month) {
        ...
        return new Fee(YearMonth.of(FeeConstants.YEAR_VALUE, month), true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidForMonthPreviousYear(final int month) {
        ...
        return new Fee(YearMonth.of(FeeConstants.PREVIOUS_YEAR_TO_DEFAULT.getValue(), month), true, contact,
    ...
    public static final Fee paidLastInYear(final long index) {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return new Fee(FeeConstants.LAST_YEAR_DATE, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidNextDate() {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return new Fee(FeeConstants.NEXT_DATE, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidNextYear(final long index) {
        ...
        return new Fee(FeeConstants.NEXT_YEAR_MONTH, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidPreviousMonth() {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return new Fee(FeeConstants.PREVIOUS_MONTH, true, contact, Optional.of(transaction));
    }
    ...
    public static final Fee paidTwoMonthsBack(final long index) {
        ...
        contact = new Fee.Member(ContactConstants.NUMBER, name);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return new Fee(FeeConstants.TWO_MONTHS_BACK, true, contact, Optional.of(transaction));
    }
