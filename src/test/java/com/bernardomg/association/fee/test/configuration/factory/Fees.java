...
public final class Fees {
    ...
    public static final Fee addPayment() {
        ...
        return Fee.paid(FeeConstants.DATE, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee alternative() {
        ...
        return Fee.paid(FeeConstants.DATE, ProfileConstants.ALTERNATIVE_NUMBER, name, transaction);
    }
    ...
    public static final Fee notPaid() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(FeeConstants.DATE, ProfileConstants.NUMBER, name);
    }
    ...
    public static final Fee notPaidCurrentMonth() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(FeeConstants.CURRENT_MONTH, ProfileConstants.NUMBER, name);
    }
    ...
    public static final Fee notPaidForMonth(final long index, final long number, final Month month) {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(YearMonth.of(FeeConstants.YEAR_VALUE, month), number, name);
    }
    ...
    public static final Fee notPaidForMonth(final long index, final Month month) {
        ...
        return Fee.unpaid(YearMonth.of(FeeConstants.YEAR_VALUE, month), index * 10, name);
    }
    ...
    public static final Fee notPaidNextYear() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(FeeConstants.NEXT_YEAR_MONTH, ProfileConstants.NUMBER, name);
    }
    ...
    public static final Fee notPaidPreviousMonth() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(FeeConstants.PREVIOUS_MONTH, ProfileConstants.NUMBER, name);
    }
    ...
    public static final Fee notPaidTwoMonthsBack() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        return Fee.unpaid(FeeConstants.TWO_MONTHS_BACK, ProfileConstants.NUMBER, name);
    }
    ...
    public static final Fee paidCurrentMonth() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return Fee.paid(FeeConstants.CURRENT_MONTH, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidFirstNextYear(final long index) {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return Fee.paid(FeeConstants.FIRST_NEXT_YEAR_DATE, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidForMonth(final int month) {
        ...
        return Fee.paid(YearMonth.of(FeeConstants.YEAR_VALUE, month), ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidForMonth(final long index, final Month month) {
        ...
        return Fee.paid(YearMonth.of(FeeConstants.YEAR_VALUE, month), index * 10, name, transaction);
    }
    ...
    public static final Fee paidLastInYear(final long index) {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return Fee.paid(FeeConstants.LAST_YEAR_DATE, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidNextDate() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return Fee.paid(FeeConstants.NEXT_DATE, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidNextYear(final long index) {
        ...
        return Fee.paid(FeeConstants.NEXT_YEAR_MONTH, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidPreviousMonth() {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, TransactionConstants.INDEX);
        return Fee.paid(FeeConstants.PREVIOUS_MONTH, ProfileConstants.NUMBER, name, transaction);
    }
    ...
    public static final Fee paidTwoMonthsBack(final long index) {
        ...
        name = new ProfileName(ProfileConstants.FIRST_NAME, ProfileConstants.LAST_NAME);
        transaction = new Fee.Transaction(FeeConstants.PAYMENT_DATE, index);
        return Fee.paid(FeeConstants.TWO_MONTHS_BACK, ProfileConstants.NUMBER, name, transaction);
    }
