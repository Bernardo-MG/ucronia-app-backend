...
public final class FeesPayments {
    ...
    public static final FeePayments duplicated() {
        return new FeePayments(FeeConstants.FEE_TYPE_NUMBER, ProfileConstants.NUMBER, FeeConstants.PAYMENT_DATE,
    ...
    public static final FeePayments paidFuture() {
        return new FeePayments(FeeConstants.FEE_TYPE_NUMBER, ProfileConstants.NUMBER, FeeConstants.PAYMENT_DATE_FUTURE,
