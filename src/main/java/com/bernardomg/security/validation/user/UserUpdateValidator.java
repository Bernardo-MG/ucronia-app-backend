...
@Component
public final class UserUpdateValidator implements Validator<Long> {

    private final Validator<Long> validator;

    public UserUpdateValidator(final UserIdExistsValidationRule userIdExistsValidationRule) {
        super();
